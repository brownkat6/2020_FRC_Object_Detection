...
#input_img_shape = tuple((192,192))
#output_img_shape = tuple((320,240))
...
def main(config):
    ...
    while True:
        ...
        #frame = cv2.resize(frame, input_img_shape)
